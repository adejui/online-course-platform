                ...
                <div
                    ...
                    <div
                        ...
                        <h6 class="dark:text-white font-bold" style="font-size: x-large;">
                            Mentor {{ $courses->first()?->mentor->user->name ?? 'Tanpa Nama' }}
                        </h6>
                    </div>
                    <div class="flex-auto px-0 pt-2 pb-2">
                        ...
                        {{ $courses->links() }}
                        <a href="{{ route('course_purchases.index') }}"
                            class="items-center px-6 py-2 mt-10 text-sm flex justify-center text-center font-bold text-white bg-slate-700 rounded-lg hover:bg-slate-800"
